...
export default function IntegrationsAsana() {
  ...
  const { data: sources, isLoading: sourcesLoading } = useQuery<IntegrationSource[]>({
    queryKey: ["/api/integrations", { systemType: "asana" }],
    queryFn: async () => {
      const res = await fetch("/api/integrations?systemType=asana");
      if (!res.ok) throw new Error("Failed to fetch Asana integrations");
      return res.json();
    },
  });
  ...
  const handleManualImport = () => {
    importMutation.mutate({
      ...
      externalEntity: "task",
      data: {
        name: manualData.taskName,
        project: manualData.projectName,
        assignee: manualData.assignee,
        due_on: manualData.dueDate,
        completed: manualData.status === "completed",
        custom_fields: { priority: manualData.priority },
      },
    });
  };
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold" data-testid="text-asana-title">Asana</h1>
            <p className="text-muted-foreground">Project Management data</p>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-2" data-testid="text-asana-title">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card data-testid="card-tasks">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">From Asana</p>
          </CardContent>
        </Card>
        ...
        <Card data-testid="card-projects">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {records.filter((r) => r.externalEntity === "project").length}
            </div>
        ...
        <Card data-testid="card-milestones">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {records.filter((r) => r.externalEntity === "milestone").length}
            </div>
      ...
      {sources && sources.length > 0 ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Asana workspaces connected to NiceHR</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardContent className="py-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium">No Asana connections</h3>
              <p className="text-muted-foreground mb-4">
                Add an Asana integration to start syncing data.
              </p>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Data synchronized from Asana</CardDescription>
              </div>
      ...
      <Dialog open={showManualEntry} onOpenChange={setShowManualEntry}>
        <DialogContent data-testid="dialog-manual-entry">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter Asana task data manually
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                value={manualData.taskName}
                onChange={(e) => setManualData({ ...manualData, taskName: e.target.value })}
              />
            </div>
            <div className="grid gap-2">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!manualData.taskName || importMutation.isPending}
            >
